...
const tamañoListRef = ref<typeof TamañoList | null>(null)
const tamañoEdit = ref<any>(null)

function handleCreate() {
  tamañoEdit.value = null
  mostrarDialog.value = true
}

function handleEdit(tamaño: any) {
  tamañoEdit.value = tamaño
  mostrarDialog.value = true
}
